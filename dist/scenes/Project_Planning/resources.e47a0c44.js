    ...
    var t, e = {
        1266: (t, e, n)=>{
            ...
            var i = function() {
                ...
                ], n && a(e, n), Object.defineProperty(e, "prototype", {
                    writable: !1
                }), t;
            }();
        },
                ...
                return e = t, n = [
                    {
                        ...
                        value: function() {
                            ...
                            c(this, u, d).call(this, e) && (e.addClass("header-sticky"), e.css({
                                top: "0"
                            }), e.outerHeight());
                            var n = r(".wh_tools").parent();
                            c(this, u, d).call(this, n) && (n.addClass("breadcrumb-sticky"), n.css({
                                top: e.outerHeight()
                            }), n.outerHeight());
                            var a = r(".wh-letters");
                            c(this, u, d).call(this, a) && (a.addClass("indexTerms-sticky"), a.css({
                                top: e.outerHeight()
                            })), c(this, p, v).call(this), window.addEventListener("hashchange", function() {
        ...
        2404: (t, e, n)=>{
            ...
            var h = function() {
                ...
                ], n && f(e, n), Object.defineProperty(e, "prototype", {
                    writable: !1
                }), t;
            }(), d = n(3193);
            function v(t, e) {
            ...
            var k = new (function() {
                ...
                return e = t, n = [
                    {
                        ...
                        value: function() {
                            ...
                            [
                                ...
                                t.preventDefault(), history.replaceState({}, "", t.target.href), d("[id='" + e + "']").length > 0 && d("html, body").animate({
                ...
                ], v(e.prototype, n), Object.defineProperty(e, "prototype", {
                    writable: !1
                }), t;
            }()), O = n(3193);
            function T(t, e) {
                ...
                return e = t, n = [
                    {
                        ...
                        value: function() {
                            [
                                ...
                                } else O("html, body").animate({
                                    scrollTop: O("[id='" + e + "']").offset().top
                                }, 1e3);
                            });
                        }
                    }
            ...
            var tt = new WeakMap, et = new WeakMap, nt = new WeakSet, ot = new WeakSet, rt = new WeakSet, at = new WeakSet, it = function() {
                function t() {
                    !function(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
                        ...
                        value: function() {
                            ...
                            if (s.Options.getBoolean("webhelp.enable.search.autocomplete")) {
                                ...
                                F("#textToSearch").on("keydown", function(t) {
                                    ...
                                    "history" == n.type && (v = "h");
                                    var w, b = F("<span>", {
                                        class: "search-autocomplete-proposal-icon " + n.type,
                                        html: v
                                    });
                                    if ("history" == n.type) {
                                        var y = F("<a>", {
            ...
            function st(t) {
                ...
                if (null != n) {
                    for(var o = t.split(" "), r = 0; r < n.length; r++)if (Y(this, at, ut).call(this, n[r], o)) {
                        var a = {
                            label: n[r],
                            value: n[r],
                            type: "history"
            ...
            var pt = s.Options.getBoolean("webhelp.enable.search.autocomplete") && !s.Options.getBoolean("webhelp.custom.search.engine.enabled"), ft = new it, ht = n(3193);
            function dt(t, e) {
                for(var n = 0; n < e.length; n++){
                    var o = e[n];
                    o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(t, o.key, o);
                ...
                return e = t, n = [
                    {
                        ...
                        value: function() {
                            ...
                            var e = Ot(".wh_tools").parent().outerHeight(), n = Ot(".wh_header").outerHeight(), o = 0, r = 0, a = 0;
                            if (s.Options.getBoolean("webhelp.enable.sticky.header")) a = t, o = e + n + (Ot(window).scrollTop() > t ? 0 : t - Ot(window).scrollTop()), r = parseInt(Ot(window).height()) - o;
                            else {
                                a = e + n + t - St(this, Ct);
                                var i = e + n + t;
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            if (t.length > 0 && e.length > 0) {
                                var n = jt(".wh_publication_toc").offset().top, o = n + parseInt(jt(".wh_publication_toc").outerHeight()), r = jt(".wh_publication_toc .active > .topicref a").offset().top;
                                if (r > .8 * o) {
                                    var a = (n + o) / 2;
            ...
            function Xt(t) {
                var e = this, n = void 0 !== t ? Math.round(t) : 0, o = Dt(".wh_tools").parent().outerHeight() + Dt(".wh_header").outerHeight();
                n += o;
                var r = null != location.hash ? location.hash : "", a = null != Dt(r).offset() ? Dt(r).offset().top : 0, i = "" != r ? Math.round(a) : 0;
            ...
            function Yt(t) {
                var e = Dt(".wh_topic_toc").offset().top, n = parseInt(Dt(".wh_topic_toc").outerHeight()), o = t.offset().top - e;
                if (o > .7 * n || o < .2 * n) {
                    var r = n / 2;
                    Dt(".wh_topic_toc").animate({
                        scrollTop: Dt(".wh_topic_toc").scrollTop() + o - r
                    }, 0);
                }
            }
            var Kt = new (function(t) {
                ...
                return e = i, n = [
                    ...
                    },
                    {
                        ...
                        value: function(t, e) {
                            if (e.length) {
                                var n = 10;
                                if (t.length && (n = 7, t.hasClass("d-md-none") && (n = 10)), e.hasClass("d-lg-block")) Dt("#wh_close_topic_toc_button").addClass("clicked"), Dt("#wh_close_topic_toc_button").attr("aria-expanded", !1), e.removeClass("d-lg-block"), e.addClass("d-lg-none"), void 0 !== (o = Dt(".wh_topic_content").parent()) && (o.removeClass("col-lg-".concat(n)), o.addClass("col-lg-".concat(n + 2)), o.addClass("closed-page-toc"));
                                else {
                                    var o;
                ...
                ], Lt(e.prototype, n), Object.defineProperty(e, "prototype", {
                    writable: !1
                }), i;
            }(xt)), Vt = n(3193);
            function te(t, e) {
                            ...
                            if (null != o) {
                                ...
                                if (P.Z.debug("jsonString: ", r), void 0 !== r && "" != r) {
                                    ...
                                    if (s.Options.getBoolean("webhelp.enable.scroll.to.search.term")) {
                                        ...
                                        void 0 !== l && Vt("html, body").animate({
                                            scrollTop: l.offset().top - j.stickyController.getStickyOffset()
                                        }, 0);
                                    }
                                }
                            }
            ...
            function fe(t) {
                ...
                try {
                    for(n.s(); !(e = n.n()).done;){
                        ...
                        0 != r && r != a && function() {
                            var t, e = 100 - Math.round((r - a) / r * 100), n = ce(o.parentNode.parentNode.querySelector(o.getAttribute("usemap")).childNodes);
                            try {
                                for(n.s(); !(t = n.n()).done;){
                                    var i = t.value;
            ...
            var he = new (function() {
                ...
                ], ue(e.prototype, n), Object.defineProperty(e, "prototype", {
                    writable: !1
                }), t;
            }()), de = "data-state", ve = "data-tocid", we = "pending", be = "not-ready", ye = "collapsed", ge = "expanded", me = "leaf", _e = "button-expand-action", ke = "button-collapse-action", Oe = "button-pending-action", Te = n(3193);
            function Se(t, e) {
                for(var n = 0; n < e.length; n++){
                    var o = e[n];
                    o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(t, o.key, o);
            ...
            var Pe = new WeakMap, Ee = function() {
                ...
                ], Se(e.prototype, n), Object.defineProperty(e, "prototype", {
                    writable: !1
                }), t;
            }(), Ie = n(3193);
            function We(t) {
            ...
            var Ze = new WeakSet, Ue = new WeakSet, Je = new WeakSet, Fe = new WeakSet, $e = new WeakSet, qe = new WeakSet, Qe = new WeakSet, Ge = new WeakSet, Xe = new WeakSet, Ye = new WeakSet, Ke = function(t) {
                !function(t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    t.prototype = Object.create(e && e.prototype, {
                        constructor: {
            ...
            function Ve(t) {
                ...
                if (e.length > 0) {
                    ...
                    var r = Ie(t.currentTarget).offset().top - Ie("#wh_publication_toc").offset().top, a = Ie(t.currentTarget).offset().left - (Ie("#wh_publication_toc").offset().left + parseInt(Ie("#wh_publication_toc").css("padding-left")));
            ...
            function nn(t) {
                var e = Ie(t.currentTarget).closest(".topicref"), n = e.attr(de), o = Ie(t.currentTarget).closest("li"), r = Ie(t.currentTarget).siblings(".title").children("a").attr("id");
            ...
            function on(t) {
                ...
                null != n && P.Z.loadJS("./" + De(Le(Ke.prototype), "_getPathToRoot", this).call(this) + "oxygen-webhelp/app/nav-links/json/" + n + ".js", function() {
                    ...
                    if (null != o) {
                        var r = o.topics, a = t.closest("li"), i = Be(e, qe, rn).call(e, r), l = Ie('<ul role="group"/>');
            ...
            var xn = new WeakMap, jn = new WeakMap, Pn = new WeakSet, En = new WeakSet, In = new WeakSet, Wn = new WeakSet, Rn = new WeakSet, zn = new WeakSet, An = new WeakSet, Hn = new WeakSet, Dn = function(t) {
                !function(t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    t.prototype = Object.create(e && e.prototype, {
                        constructor: {
                ...
                return e = i, n = [
                    {
                        ...
                        value: function() {
                            ...
                            pn(document).on("click", ".wh_top_menu a", function(n) {
                                ...
                                var r = pn(n.currentTarget).closest("li"), a = r.hasClass("active"), i = r.hasClass("has-children");
                                if (a || !i) return window.location = pn(n.currentTarget).attr("href"), n.preventDefault(), n.stopImmediatePropagation(), !1;
                                n.preventDefault();
                            });
                        }
                    }
                ], hn(e.prototype, n), Object.defineProperty(e, "prototype", {
                    writable: !1
                }), i;
            }(Ee);
            function Mn(t) {
            ...
            function Ln(t) {
                var e, n = On(this, xn) ? "left" : "right", o = pn(".wh_top_menu ul").index(t.parent("ul")), r = parseInt(t.offset().left), a = r + parseInt(t.width()), i = parseInt(t.children("ul").width()), l = a + i;
            ...
            function Nn(t) {
                ...
                null != n && P.Z.loadJS("./" + bn(gn(Dn.prototype), "_getPathToRoot", this).call(this) + "oxygen-webhelp/app/nav-links/json/" + n + ".js", function() {
                    var o = oxy_webhelp_navlinks[n];
                    if (null != o) {
                        var r = o.topics, a = t.closest("li"), i = Tn(e, Wn, Bn).call(e, r), l = a.children("ul.loading");
            ...
            function Xn(t, e, n) {
                return e && Gn(t.prototype, e), n && Gn(t, n), Object.defineProperty(t, "prototype", {
                    writable: !1
                }), t;
            }
                ...
                return e = t, n = [
                    {
                        key: "getParameter",
                        value: function(t) {
                            var e, n, r, a = new URLSearchParams(window.location.search), i = new URLSearchParams, l = function(t, e) {
                                var n = "undefined" != typeof Symbol && t[Symbol.iterator] || t["@@iterator"];
                                if (!n) {
...
//# sourceMappingURL=resources.e47a0c44.js.map
